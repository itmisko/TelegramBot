...
//  
//
//  Created by Sergei Mishchenko on 29.07.2022.
//
...
//        buttonsActionHandler(app: app, bot: bot)
    ...
    private static func commandCatHandler(app: Vapor.Application, bot: TGBotPrtcl) {
        let handler = TGCommandHandler(commands: ["/cat"]) { update, bot in
            app.http.client.shared.get(url: "https://raw.githubusercontent.com/netology-code/jd-homeworks/master/http/task1/cats").whenSuccess {result in
